...
exports.connect = function(database_path) {
  ...
  return {
    ...
    ,
    getFacePosition:function(face_id){

      console.log("sqlite3.getFacePosition: ",face_id);

      return JSON.parse(executeSQL("SELECT position FROM faces WHERE face_id='" + face_id + "'")[0]);
